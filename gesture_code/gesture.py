    ...
    if result.multi_hand_landmarks is not None:
        ...
        for res in result.multi_hand_landmarks:
            ...
            if idx in coin_gesture.keys():
                ...
                cv2.putText(img, text=coin_gesture[idx].upper(), org=(org[0], org[1] + 20),
                ...
                cv2.putText(img, text='(%.2f, %.2f)' % (x, y), org=(org[0], org[1] - 20),
                            fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(255, 255, 255), thickness=2)
        ...
        if total_num != 0:
            cv2.putText(img, text="Total Num is %i" % (total_num), org=(int(img.shape[1] / 3), int(img.shape[0] / 3)),
                        fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1.5, color=(0, 0, 255), thickness=3)
